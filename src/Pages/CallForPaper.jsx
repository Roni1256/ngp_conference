...
const CallForPaper = () => {
  ...
  return (
    <div className='py-20 px-10 bg-white'>
        ...
        <h2 className='text-2xl font-semibold text-neutral-700 mb-6'>Conference Tracks</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-8">
            {
                topics.map((topic, index) =>{
                    return (
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 rounded-lg border border-blue-100 shadow-sm hover:shadow-md transition-all duration-300" key={index}>
        ...
        <div className="mt-20">
            <h2 className='text-2xl font-semibold text-neutral-700 mb-6'>Paper Review Process</h2>
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 rounded-lg border border-blue-100 shadow-sm">
                <p className="text-gray-700 mb-4 italic">Our rigorous review process ensures the highest quality of accepted papers:</p>
        ...
        <div className="mt-16">
            <h2 className='text-2xl font-semibold text-neutral-700 mb-6'>Evaluation Criteria</h2>
            <div className="grid md:grid-cols-2 gap-6">
                {evaluationCriteria.map((criterion, index) => (
                    <div key={index} className="bg-white p-6 rounded-lg border-l-4 border-l-indigo-600 shadow-md flex items-center">
        ...
        <div className="mt-16">
            <h2 className='text-2xl font-semibold text-neutral-700 mb-6'>Ensuring Author Presentation</h2>
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-8">
                <div className="flex items-center mb-6">
                    ...
                    <p className="text-amber-800 font-semibold">To ensure the quality and integrity of the conference:</p>
                </div>
                ...
                <div className="mt-8 p-4 bg-amber-100 rounded-lg border border-amber-200">
                    <p className="text-amber-800 font-bold text-center">Important: Our "No Show = No Publication" policy will be strictly enforced</p>
                </div>
            </div>
        </div>
    </div>
